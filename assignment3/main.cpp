...
void validSubmittedFilesles(string filename, string *allowedIncludingFiles, int numOfAllowedIncludingFiles = 1)
{
...
int main(int argc, char **argv)
{
    ...
    // test(argv[1]);
    test("/home/dogboy/Documents/DogBoy/KietD/assignment3/test.txt");
